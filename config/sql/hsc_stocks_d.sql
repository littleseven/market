...
CREATE TABLE `hsc_stocks_d` (
  ...
  `is_ss` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '是否标普500 成分股',
  `is_sz` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '是否纳斯达克成分股',
  `is_hs` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '是否恒生综合成分股',
  `weight` decimal(20,3) DEFAULT NULL COMMENT '恒生综合权重',
